...
public final class CDHelper {
    ...
    fileprivate init(dataSchemeName: String?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.applicationWillTerminate(notification:)), name: .NSExtensionHostDidEnterBackground, object: nil)
    }

    deinit {
        NotificationCenter.default.removeObserver(self, name: .NSExtensionHostDidEnterBackground, object: nil)
    }
